...
And a vaga "1" do setor "CIn" já está reservada para "Gabriel"
And a vaga "2" do setor "CCEN" está disponível
When o usuario "Gabriel" tenta reservar a vaga "2" do setor "CCEN"
Then o sistema reserva a vaga "2" para o usuário "Gabriel"
And a vaga "1" do setor "CIn" está disponível
@ignore
